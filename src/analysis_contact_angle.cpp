...
ANALYSIS_CONTACT_ANGLE::ANALYSIS_CONTACT_ANGLE(PSF *system, GROUP *sel1, GROUP *sel2, int vector1d, int vector2d, int voidf, string filename, float dist_crit, float dr)
{
    this->system = system;
    this->sel1 = sel1;
    this->sel2 = sel2;
