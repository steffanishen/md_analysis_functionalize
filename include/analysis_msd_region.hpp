...
#ifndef ANALYSIS_MSD_REGION_HPP
#define	ANALYSIS_MSD_REGION_HPP

using namespace std;

class  ANALYSIS_MSD_REGION : public ANALYSIS
{
...
//    GROUP *sel1;
 //   int whichN;
    ...
    vector<float> msd_region();
    vector<float> msd_region_x();
    vector<float> msd_region_y();
    vector<float> msd_region_z();
