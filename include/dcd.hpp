...
protected:
    ...
    std::fstream dcdf;  // for opening dcd file, MS comment: Note this dcdf is an fstream object, not a DCD or DCD_R object.
...
//    const vector<float> getXV() const;
//    const vector<float> getYV() const;
//    const vector<float> getZV() const;
    //vector<float> getX() ;
